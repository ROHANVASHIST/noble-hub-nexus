        ...
        <div className="min-h-screen flex items-center justify-center p-4 bg-background">
            <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="w-full max-w-md space-y-8">
                <div className="text-center">
                    ...
                    <p className="mt-2 text-muted-foreground">Explore the history and achievements of Nobel Laureates</p>
                </div>
                    ...
                    <form onSubmit={handleAuth} className="space-y-4">
                        ...
                        <div className="space-y-2">
                            ...
                            <div className="relative">
                                ...
                                <Input id="password" type="password" placeholder="••••••••" className="pl-10" value={password} onChange={(e) => setPassword(e.target.value)} required minLength={8} maxLength={128} autoComplete={isSignUp ? "new-password" : "current-password"} />
                            </div>
                        ...
                        <Button className="w-full h-11 bg-primary text-primary-foreground font-semibold" disabled={loading || googleLoading}>
                            {loading ? <Loader2 className="h-4 w-4 animate-spin" /> : <>{isSignUp ? "Create Account" : "Sign In"} <ArrowRight className="ml-2 h-4 w-4" /></>}
                        </Button>
                    </form>
