...
import { Award, Mail, Lock, User, ArrowRight, Loader2, KeyRound } from "lucide-react";
            ...
            <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="w-full max-w-md space-y-8">
                <div className="text-center">
                    ...
                    <p className="mt-2 text-muted-foreground">
                        {mode === "forgot" ? "We'll send you a link to reset your password." : "Explore the history and achievements of Nobel Laureates"}
                    </p>
                </div>
                ...
                <div className="bg-card border border-border/50 rounded-2xl p-8 shadow-sm">
                    <form onSubmit={handleAuth} className="space-y-4">
                        ...
                        <Button type="submit" className="w-full h-11 bg-primary text-primary-foreground font-semibold" disabled={loading || googleLoading}>
                    ...
                    <div className="mt-6 text-center">
                        <p className="text-sm text-muted-foreground">
                            ...
                            <button type="button" onClick={() => setMode(mode === "signup" ? "signin" : mode === "forgot" ? "signin" : "signup")} className="text-primary font-semibold hover:underline">
