...
import { RESEARCH_PAPER_FORMAT } from "@/frontend/components/papers/paperFormats";
        ...
        >
          <div>
            ...
            <h1 className="font-display text-4xl font-bold">
              {RESEARCH_PAPER_FORMAT.name}
            </h1>
            <p className="mt-2 text-muted-foreground max-w-2xl">
              {RESEARCH_PAPER_FORMAT.tagline}. Fill each section, save drafts to
              your dashboard, and export a polished PDF or Word document.
            </p>
          </div>
        </motion.header>

        <PaperFormatEditor format={RESEARCH_PAPER_FORMAT} />
      </div>
    </PageLayout>
  );
};
