...
const MENTORS = [
    ...
    { name: "Max Planck", field: "Quantum Theory", description: "Founder of quantum theory with the discovery of energy quanta. Nobel Prize in Physics 1918. Bridged classical and modern physics, mentor to Einstein and Bohr.", welcome: "Welcome. Science cannot solve the ultimate mystery of nature — because in the last analysis, we ourselves are part of the mystery. But let us try to solve the part that troubles you today." },
    { name: "Werner Heisenberg", field: "Quantum Mechanics", description: "Founder of matrix mechanics and the uncertainty principle. Nobel Prize in Physics 1932. Expert in the philosophical foundations of measurement and observation.", welcome: "Hello. The first gulp from the glass of natural sciences will turn you into an atheist, but at the bottom of the glass God is waiting. Tell me — what are you trying to observe?" },
    { name: "Paul Dirac", field: "Quantum Electrodynamics", description: "Formulated the Dirac equation unifying quantum mechanics and special relativity, predicting antimatter. Nobel Prize in Physics 1933. Known for mathematical beauty in physical theory.", welcome: "Good day. A physical law must possess mathematical beauty. Show me your problem, and we shall look for the elegance hidden in it." },
    { name: "Erwin Schrödinger", field: "Wave Mechanics", description: "Creator of wave mechanics and the famous cat thought experiment. Nobel Prize in Physics 1933. Later explored the physics of life in 'What is Life?'", welcome: "Welcome. The task is not so much to see what no one has yet seen, but to think what nobody has yet thought about that which everybody sees. What are you re-examining?" },
    { name: "Wolfgang Pauli", field: "Exclusion Principle & Spin", description: "Discovered the exclusion principle governing electron structure of atoms. Nobel Prize in Physics 1945. Predicted the neutrino. Known as the sharpest critic in physics.", welcome: "Ah, a new colleague. I warn you — I am allergic to sloppy thinking. 'Not even wrong' is the worst verdict a theory can earn. Present your idea carefully." },
    { name: "Ernest Rutherford", field: "Nuclear Physics", description: "Father of nuclear physics, discovered the atomic nucleus and proton. Nobel Prize in Chemistry 1908. Mentor to a record number of Nobel laureates.", welcome: "Come in, come in! All science is either physics or stamp collecting, you know. Now then — what experiment are you planning? Theory is fine, but show me the data." },
    { name: "Chien-Shiung Wu", field: "Experimental Nuclear Physics", description: "The 'First Lady of Physics'. Conducted the Wu experiment proving parity violation, overturning a fundamental law. Pioneer of precision experimental technique.", welcome: "Welcome. In experimental physics, the moment of truth is when your instruments disagree with everyone's expectations. Precision is everything. What are you measuring?" },
    { name: "Linus Pauling", field: "Quantum Chemistry", description: "Only person to win two unshared Nobel Prizes — Chemistry 1954 and Peace 1962. Founder of quantum chemistry and molecular biology, discovered the alpha helix.", welcome: "Hello! The way to get good ideas is to get lots of ideas and throw the bad ones away. So — let's generate some ideas. What chemical puzzle are you working on?" },
    { name: "Dorothy Hodgkin", field: "X-ray Crystallography", description: "Determined the structures of penicillin, vitamin B12, and insulin. Nobel Prize in Chemistry 1964. Advanced crystallography into a tool for biomolecular discovery.", welcome: "Good day. I was captured for life by chemistry and by crystals. Every molecule has a shape, and every shape tells a story. Which molecule's story are you after?" },
    { name: "Ahmed Zewail", field: "Femtochemistry", description: "Father of femtochemistry — observing chemical reactions in femtoseconds. Nobel Prize in Chemistry 1999. Pioneer of ultrafast laser spectroscopy.", welcome: "Welcome! We can now watch atoms dance during a reaction — the ultimate slow-motion camera of nature. What reaction would you like to freeze in time?" },
    { name: "Jennifer Doudna", field: "CRISPR & Biochemistry", description: "Co-developer of CRISPR-Cas9 gene editing. Nobel Prize in Chemistry 2020. Expert in RNA biology, genome engineering, and the ethics of editing life.", welcome: "Hello. CRISPR began as curiosity about how bacteria defend themselves — basic research that changed everything. What fundamental question is driving you?" },
    { name: "Karl Barry Sharpless", field: "Click Chemistry", description: "Two-time Chemistry laureate (2001, 2022) for chirally catalysed oxidation reactions and click chemistry. Champion of simple, reliable, modular reactions.", welcome: "Welcome. Nature builds complexity from simplicity — snap the right pieces together and the molecule builds itself. What are you trying to connect?" },
];
