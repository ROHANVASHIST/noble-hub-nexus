            ...
            <html>
                <head>
                    ...
                    <style>
                        ...
                        h1 { color: #8B5CF6; font-size: 28px; border-bottom: 2px solid #8B5CF6; padding-bottom: 10px; }
                        .meta { color: #666; font-size: 12px; margin-bottom: 30px; }
                        .content { line-height: 1.6; white-space: pre-wrap; font-size: 14px; }
                        .footer { margin-top: 50px; border-top: 1px solid #eee; padding-top: 20px; font-size: 10px; color: #999; }
                    </style>
                </head>
                <body>
                    <h1>${note.title}</h1>
                    <div class="meta">Research Date: ${note.date} | Entry Type: ${note.type.toUpperCase()}</div>
                    <div class="content">${note.content}</div>
                    <div class="footer">Generated by PhD Research OS - Noble Hub Nexus</div>
        ...
        <PageLayout>
            ...
            <Dialog open={!!editingNote} onOpenChange={(open) => !open && setEditingNote(null)}>
                <DialogContent className="sm:max-w-[700px] bg-card border-primary/20 rounded-3xl">
                    <DialogHeader>
                        <DialogTitle className="text-2xl font-display font-bold">Edit Research Entry</DialogTitle>
                    </DialogHeader>
                    <div className="space-y-6 py-4">
                        ...
                        <div className="space-y-2">
                            ...
                            <Textarea
                                ...
                                className="min-h-[300px] rounded-2xl border-border bg-secondary/30 resize-none"
                            />
                        </div>
                    </div>
                    <DialogFooter>
                        ...
                        <>
                            <div className="p-12 pb-6 border-b border-white/5">
                                <div className="flex justify-between items-start mb-6">
                                    ...
                                    <div className="flex gap-2">
                                        <Button variant="ghost" size="sm" className="rounded-full h-12 w-12 p-0 text-white hover:bg-white/5" onClick={() => handleExportNote(viewingNote)}>
                                            <Download className="h-5 w-5" />
                                        </Button>
                                        <Button variant="ghost" size="sm" className="rounded-full h-12 w-12 p-0 text-white hover:bg-white/5" onClick={() => setViewingNote(null)}>
                            ...
                            <div className="flex-1 overflow-y-auto p-12 custom-scrollbar">
                                <div className="prose prose-invert max-w-none">
                                    <p className="text-lg leading-relaxed text-slate-300 font-serif whitespace-pre-wrap">
                                        {viewingNote.content}
                                    </p>
                                </div>
                            </div>
                            <div className="p-8 bg-black/40 border-t border-white/5 flex justify-center gap-4">
                                <Button variant="outline" className="rounded-2xl border-white/10 text-white hover:bg-white/5 px-8" onClick={() => {
